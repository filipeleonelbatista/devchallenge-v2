          ...
          <div className="w-full flex items-center justify-center">
            <div className="flex flex-col w-4/5 flex p-4">
              ...
              <p>
                ...
                <a
                  className="text-yellow-400 font-bold"
                  href="https://devchallenge-v2.vercel.app/privacy-policies"
                  target="_BLANK"
                >
                  políticas de privacidade
                </a>
              ...
              <p>
                ...
                de nossas práticas em torno de{" "}
                <a
                  className="text-yellow-400 font-bold"
                  href="https://devchallenge-v2.vercel.app/privacy-policies"
                  target="_BLANK"
              ...
              <h2 className="text-xl font-bold" style={{ marginTop: 24 }}>
                Política de Cookies DevChallenge
              </h2>
              <h3 className="text-lg font-bold" style={{ marginTop: 24 }}>
                O que são cookies?
              </h3>
              <p>
              ...
              <ul>
                <li>
                  ...
                  <br />
                  <br /> Se você criar uma conta connosco, usaremos cookies para
                  o gerenciamento do processo de inscrição e administração
                  geral. Esses cookies geralmente serão excluídos quando você
                  sair do sistema, porém, em alguns casos, eles poderão
                  permanecer posteriormente para lembrar as preferências do seu
                  site ao sair.
                  <br />
                  <br />{" "}
                </li>
                ...
                <li>
                  ...
                  para fornecer informações interessantes, ferramentas úteis ou
                  para entender nossa base de usuários com mais precisão. Essas
                ...
                <li>
                  ...
                  <br />
                  <br /> Quando você envia dados por meio de um formulário como
                ...
                <li>
                  ...
                  como esse site é executado quando você o usa. Para lembrar
                  suas preferências, precisamos definir cookies para que essas
              ...
              <p>
                ...
                informação que o DevChallenge oferece no site e com caráter
              ...
              <ul>
                ...
                <li>
                  ...
                  racista, xenofóbica, ou azar, qualquer tipo de pornografia
                  ilegal, de apologia ao terrorismo ou contra os direitos
                  humanos;
                </li>
                <li>
                  C{")"} Não causar danos aos sistemas físicos (hardwares) e
                  lógicos (softwares) do DevChallenge, de seus fornecedores ou
              ...
              <p>
                Esta política é efetiva a partir de <strong>Setembro</strong>/
                <strong>2023</strong>.
              </p>
            </div>
          </div>
